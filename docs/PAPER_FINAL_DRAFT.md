...
| **Total** | **154,483** | **49,663** | **67.9** | not summed† | **692** |

†The "Logged Area" column reports total logged *forest* area within each zone (all non-old-growth forested land), a distinct and larger quantity than the area of logged *yew habitat*. It is not summed because zone totals reflect overall forest disturbance, not yew-specific loss; the estimated logged yew-habitat area (original minus remaining) is 104,820 ha.
